...
folder_path = '/Downloads/physionet/files/challenge-2021/1.0.3/training/st_petersburg_incart/All'
    ...
    if filename.endswith(".mat"):
        ...
        # Storing split arrays in a list called fourth_arrays
            ...
            ## CHECK THE SAMPLING RATE! ##
                ecg_plot.plot(final_array, title=plot_title, columns=4, lead_order=[0,1,2,12,3,4,5,13,6,7,8,14,9,10,11,15], show_grid=False)
