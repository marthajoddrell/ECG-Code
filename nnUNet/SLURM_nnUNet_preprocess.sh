...
export nnUNet_raw="/sharedscratch/nnUNet/nnUNet_raw"
export nnUNet_results="/sharedscratch/nnUNet/nnUNet_results"
export nnUNet_preprocessed="/sharedscratch/nnUNet/nnUNet_preprocessed"
